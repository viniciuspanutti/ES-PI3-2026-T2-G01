...
// HomeHeader = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
...
class HomeHeader extends StatelessWidget {
  ...
  // primaryPurple = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  ...
  // userName = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String userName;
  // Analise da Linha: final String? userPhotoUrl;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // userPhotoUrl = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String? userPhotoUrl;
  // Analise da Linha: final bool showBalance;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // bool = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // showBalance = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  // onToggleVisibility = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final VoidCallback onToggleVisibility;
  // Analise da Linha: final VoidCallback onNotificationsTap;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onNotificationsTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _ProfileAvatar = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _ProfileAvatar extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // photoUrl = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  Widget build(BuildContext context) {
    ...
    // source = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    ...
    // (source != null && source.isNotEmpty) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
    // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
    if (source != null && source.isNotEmpty) {
      // Analise da Linha: if (source.startsWith('http')) {
      // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
      // (source.startsWith('http')) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
      // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _DefaultProfileAvatar = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
...
// ALTERADO: StatelessWidget para StatefulWidget para buscar saldo
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// WalletCard = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
...
class WalletCard extends StatefulWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onCardTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _WalletCardState = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de State<WalletCard>.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _WalletCardState extends State<WalletCard> {
  // Analise da Linha: double _saldo = 0;
  // double = Tipo da Variavel. Define quais valores podem ser armazenados nesta propriedade.
  // _saldo = Identificador da Variavel. Nome interno usado pelo estado do widget.
  ...
  // _carregando = Identificador da Variavel. Nome interno usado pelo estado do widget.
  // = = Operador de Atribuicao. Define o valor inicial da variavel.
  // ; = Finalizador de Instrucao. Encerra a declaracao da variavel.
  ...
  // initState = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  void initState() {
  ...
  // void = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _ouvirSaldo = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  void _ouvirSaldo() {
    // Analise da Linha: final uid = FirebaseAuth.instance.currentUser?.uid;
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // uid = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
    ...
    // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
    // (uid == null) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
    // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
    if (uid == null) {
    ...
    // Analise da Linha: FirebaseFirestore.instance
    // Linha = Instrucao Dart. Participa da declaracao, configuracao ou composicao da interface.
    FirebaseFirestore.instance
        ...
        .listen((snap) {
          ...
          setState(() {
            ...
            // _saldo = Identificador Reatribuido. Variavel existente que recebera novo valor.
            // = = Operador de Atribuicao. Substitui o valor anterior pelo valor da direita.
            // (snap.data()?['saldo'] as num? ?? 0).toDouble() = Expressao de Valor. Resultado que passa a ser armazenado.
            ...
            // _carregando = Identificador Reatribuido. Variavel existente que recebera novo valor.
            // = = Operador de Atribuicao. Substitui o valor anterior pelo valor da direita.
            // false = Expressao de Valor. Resultado que passa a ser armazenado.
            // ; = Finalizador de Instrucao. Encerra a reatribuicao.
            _carregando = false;
            // Analise da Linha: });
            // } = Fechamento de Bloco. Encerra o escopo aberto anteriormente.
  ...
  Widget build(BuildContext context) {
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // saldoTexto = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _CardActionChip = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _CardActionChip extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // IconData = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // icon = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final IconData icon;
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _TapTarget = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// QuickActions = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class QuickActions extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // ValueChanged<String> = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onRouteTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  Widget build(BuildContext context) {
    ...
    // background = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _QuickActionButton = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// HomeBottomNavigationBar = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _NavIcon = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _NavIcon extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // bool = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // isActive = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final bool isActive;
  // Analise da Linha: final VoidCallback onTap;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  ...
  Widget build(BuildContext context) {
    ...
    // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
    // (isActive) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
    // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
    if (isActive) {
      // Analise da Linha: return Material(
      // return = Instrucao de Retorno. Entrega um valor e encerra a execucao atual.
