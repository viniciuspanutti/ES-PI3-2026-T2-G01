...
// FirestoreInvestmentSections = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
...
class FirestoreInvestmentSections extends StatelessWidget {
  ...
  const FirestoreInvestmentSections({
    ...
    // required = Modificador de Obrigatoriedade. Exige que quem cria o widget informe este parametro.
  ...
  // String? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // userId = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String? userId;
  // Analise da Linha: final Color backgroundColor;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // Color = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // backgroundColor = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final Color backgroundColor;
  // Analise da Linha: final Color statusColor;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // Color = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // statusColor = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final Color statusColor;
  // Analise da Linha: final Color growthColor;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // Color = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // growthColor = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final Color growthColor;
  // Analise da Linha: final VoidCallback onRetry;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onRetry = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final VoidCallback onRetry;
  // Analise da Linha: final VoidCallback onViewAllTap;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onViewAllTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final VoidCallback onViewAllTap;
  // Analise da Linha: final ValueChanged<StartupDetail> onStartupTap;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // ValueChanged<StartupDetail> = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onStartupTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final ValueChanged<StartupDetail> onStartupTap;
  // Analise da Linha: final VoidCallback onMoreTap;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onMoreTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  Widget build(BuildContext context) {
    ...
    // (userId == null) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
    ...
    if (userId == null) {
      ...
      return _buildSection(
        ...
        message:
            'Voc\u00ea ainda n\u00e3o possui investimentos em carteira. '
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
        // (snapshot.hasError) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
        // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
        ...
        // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
        // investedIds = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
        // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
        ...
        // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
        // (investedIds.isEmpty) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
        // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
        ...
        return FutureBuilder<List<StartupDetail>>(
          ...
          builder: (context, startupSnap) {
            ...
            // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
            // (startupSnap.connectionState == ConnectionState.waiting) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
            // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
            ...
            // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
            // startups = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
            // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
            ...
            // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
            // investments = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
            // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
  ...
  Widget _buildSection({
    ...
    return _InvestmentSection(
      ...
      onItemTap: (item) {
        ...
        // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
        // startup = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
        // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
Future<List<StartupDetail>> _fetchInvestedStartups(
  ...
  // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
  // service = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
  // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _SectionTapTarget = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _SectionTapTarget extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // VoidCallback = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final VoidCallback onTap;
  // Analise da Linha: final Widget child;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // Widget = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // child = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final Widget child;
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _InvestmentSection = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _InvestmentSection extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // title = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String title;
  // Analise da Linha: final List<_InvestmentItemData> items;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // List<_InvestmentItemData> = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // items = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // bool = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // showMoreButton = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final bool showMoreButton;
  // Analise da Linha: final bool showViewAll;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // bool = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // showViewAll = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final bool showViewAll;
  // Analise da Linha: final String emptyMessage;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // emptyMessage = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // ValueChanged<_InvestmentItemData>? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // onItemTap = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
              // (showMoreButton) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
              if (showMoreButton)
          ...
          // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
          // (items.isEmpty) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
          if (items.isEmpty)
          ...
          // else = Caminho Alternativo. Executa quando as condicoes anteriores nao foram atendidas.
          else
            ...
            for (var index = 0; index < items.length; index++) ...[
              ...
              // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
              // (index != items.length - 1) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _SectionEmptyState = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _SectionEmptyState extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // message = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _InvestmentListTile = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _InvestmentListTile extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // _InvestmentItemData = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // item = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
                    // (item.variation.isNotEmpty) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
                    ...
                    // else if = Condicao Alternativa. Testa uma segunda possibilidade quando o if anterior falhou.
                    // (item.subtitle.isNotEmpty) = Expressao Condicional. Define a regra desta alternativa.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _CompanyLogo = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _CompanyLogo extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // imageUrl = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String? imageUrl;
  // Analise da Linha: final String fallbackLabel;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // fallbackLabel = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  ...
  Widget build(BuildContext context) {
    ...
    // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
    // logo = = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
    // imageUrl = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
    // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
    final logo = imageUrl;
    ...
    // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
    // (logo != null && logo.isNotEmpty) = Expressao Condicional. Teste logico avaliado antes de executar o bloco.
    // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
    if (logo != null && logo.isNotEmpty) {
      // Analise da Linha: final image = logo.startsWith('http')
      // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
      // image = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
      // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _LogoFallback = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
// extends = Relacao de Heranca. Faz a classe receber comportamento base de StatelessWidget.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _LogoFallback extends StatelessWidget {
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // label = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String label;
  ...
  Widget build(BuildContext context) {
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // initials = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
// _formatCurrencyCents = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
// ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
// { = Abertura de Bloco. Inicia o corpo executavel.
...
// String = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
// _formatPercent = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
// ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
// { = Abertura de Bloco. Inicia o corpo executavel.
...
// String = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
// _stageLabel = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
// ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
// { = Abertura de Bloco. Inicia o corpo executavel.
...
class _InvestmentItemData {
  ...
  factory _InvestmentItemData.fromStartup(StartupDetail startup) {
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // valueCents = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // company = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String company;
  // Analise da Linha: final String subtitle;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // subtitle = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String subtitle;
  // Analise da Linha: final String variation;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // variation = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String variation;
  // Analise da Linha: final String status;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // status = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String status;
  // Analise da Linha: final String value;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // value = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String value;
  // Analise da Linha: final String? imageUrl;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // StartupDetail? = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // startup = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
