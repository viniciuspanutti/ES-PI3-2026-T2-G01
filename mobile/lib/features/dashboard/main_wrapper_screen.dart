...
import 'package:mobile/features/wallet/presentation/trade_market.dart'
    ...
    // as = Palavra-chave de Alias. Cria um apelido para acessar membros do import sem conflito de nomes.
    // camila_market = Identificador do Alias. Nome usado para chamar classes e funcoes desse import.
    // ; = Finalizador de Instrucao. Operador que indica o fim da diretiva de importacao.
    as camila_market;
...
// MainWrapperScreen = Identificador da Classe. Nome tecnico usado para instanciar ou referenciar essa estrutura.
...
class MainWrapperScreen extends StatefulWidget {
  ...
  // MainWrapperScreen = Identificador do Construtor. Usa o mesmo nome da classe que esta sendo criada.
...
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo no Dart.
// _MainWrapperScreenState = Identificador da Classe. Nome tecnico usado para instanciar ou referenciar essa estrutura.
// extends = Relacao de Heranca. Indica que esta classe recebe comportamento base de State<MainWrapperScreen>.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _MainWrapperScreenState extends State<MainWrapperScreen> {
  // Analise da Linha: int _currentIndex = 0;
  // int = Tipo da Variavel. Define quais valores podem ser armazenados aqui.
  // _currentIndex = Identificador da Variavel. Nome tecnico usado para acessar esse valor no codigo.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: [
        ...
        // , = Separador. Mantem a lista de argumentos ou elementos em continuidade.
        const ProfileScreen(),
      // Analise da Linha: ][_currentIndex],
      // Linha = Instrucao Dart. Participa da declaracao, configuracao ou composicao da interface.
      // , = Separador. Mantem a lista de argumentos ou elementos em continuidade.
      ][_currentIndex],
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildBalcaoComTrava = Identificador da Funcao/Metodo. Nome tecnico usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  Widget _buildBalcaoComTrava() {
    ...
    // userId = Identificador da Variavel. Nome tecnico usado para acessar o resultado depois.
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      // } = Fechamento de Bloco. Encerra o escopo aberto anteriormente.
        ...
        // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
        // isInvestor = Identificador da Variavel. Nome tecnico usado para acessar o resultado depois.
        // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
        ...
        // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
        // (isInvestor) = Expressao Condicional. Teste logico avaliado antes do bloco.
        // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
        if (isInvestor) {
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildBalcaoBloqueado = Identificador da Funcao/Metodo. Nome tecnico usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildNavItem = Identificador da Funcao/Metodo. Nome tecnico usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  Widget _buildNavItem(IconData icon, String label, int index) {
    ...
    // isSelected = _currentIndex == = Tipo Declarado. Define a categoria de dado aceita por este campo.
    // index = Identificador da Variavel. Nome tecnico usado para acessar esse valor no codigo.
    // ; = Finalizador de Instrucao. Operador que indica o fim da declaracao.
    final isSelected = _currentIndex == index;
    // Analise da Linha: if (isSelected) {
    // if = Estrutura Condicional. Executa o bloco somente se a condicao for verdadeira.
    // (isSelected) = Expressao Condicional. Teste logico avaliado antes do bloco.
    // { = Abertura de Bloco Condicional. Inicia as instrucoes do if.
    if (isSelected) {
