...
class _MainWrapperScreenState extends State<MainWrapperScreen> {
  ...
  final List<Widget> _screens = [ 
    const BalcaoNegociacaoPage(),   // 0 - AGORA O BALCÃO É A HOME
    const CatalogoStartupsPage(),   // 1 
    const ProfileSecurityScreen(),  // 2 
  ]; 
        ...
        child: Row( 
          ...
          children: [ 
            GestureDetector( 
              ...
              child: _buildNavItem(Icons.account_balance_outlined, "Balcão", 0), 
            ), 
            GestureDetector( 
            ...
            GestureDetector( 
              ...
              child: _buildNavItem(Icons.person_outline, "Perfil", 2), 
            ), 
          ], 
        ), 
      ), 
