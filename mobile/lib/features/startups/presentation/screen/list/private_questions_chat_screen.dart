...
// PrivateQuestionsChatScreen = Identificador da Classe. Nome usado para instanciar ou referenciar este widget/objeto.
...
class PrivateQuestionsChatScreen extends StatefulWidget {
  ...
  // ; = Finalizador de Instrucao. Encerra a declaracao do construtor.
  ...
  // =============================================================================
  // Analise da Linha: State<PrivateQuestionsChatScreen> createState() => _PrivateQuestionsChatScreenState();
  // State<PrivateQuestionsChatScreen> = Tipo de Retorno. Define o estado que sera criado para este StatefulWidget.
  // createState = Identificador do Metodo. Nome chamado pelo Flutter para construir o objeto de estado.
  // => = Arrow Function. Retorna a expressao da direita de forma compacta.
  // _PrivateQuestionsChatScreenState() = Instancia Retornada. Cria o estado privado que controla esta tela.
...
// =============================================================================
// Analise da Linha: class _PrivateQuestionsChatScreenState extends State<PrivateQuestionsChatScreen> {
// class = Palavra-chave de Declaracao de Classe. Inicia um novo tipo do Dart.
// _PrivateQuestionsChatScreenState = Identificador da Classe. Nome usado para instanciar ou referenciar este objeto de estado.
// extends = Relacao de Heranca. Faz esta classe receber o comportamento base de State<PrivateQuestionsChatScreen>.
// { = Abertura de Bloco. Inicia o corpo da classe.
class _PrivateQuestionsChatScreenState
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // TextEditingController = Tipo Declarado. Define a categoria de dado que esta variavel aceita.
  // _messageController = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // ScrollController = Tipo Declarado. Define a categoria de dado que esta variavel aceita.
  // _scrollController = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // = = Operador de Atribuicao. Define o valor inicial da variavel.
  // ; = Finalizador de Instrucao. Encerra a declaracao da variavel.
  ...
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // List<_PrivateChatMessage> = Tipo Declarado. Define a categoria de dado que esta variavel aceita.
  // _messages = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // = = Operador de Atribuicao. Define o valor inicial da variavel.
  // ; = Finalizador de Instrucao. Encerra a declaracao da variavel.
  ...
  // dispose = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildStartupHeader = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  Widget _buildStartupHeader() {
    ...
    // startupName = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildEmptyState = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildMessageBubble = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  Widget _buildMessageBubble(_PrivateChatMessage message) {
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // bubbleColor = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // textColor = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
  ...
  // Widget = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _buildMessageComposer = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  Widget _buildMessageComposer() {
    // Analise da Linha: final hasText = _messageController.text.trim().isNotEmpty;
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // hasText = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
  ...
  // void = Tipo de Retorno. Define o tipo de valor que esta funcao ou metodo entrega.
  // _sendMessage = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  void _sendMessage() {
    // Analise da Linha: final text = _messageController.text.trim();
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // text = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
  ...
  // _formatTime = Identificador da Funcao/Metodo. Nome usado para chamar este bloco de comportamento.
  // ( ) = Delimitadores de Parametros. Contem os dados recebidos pela funcao ou metodo.
  // { = Abertura de Bloco. Inicia o corpo executavel.
  String _formatTime(DateTime dateTime) {
    // Analise da Linha: final hour = dateTime.hour.toString().padLeft(2, '0');
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // hour = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
    ...
    // final = Modificador de Declaracao. Cria uma variavel local com valor unico ou constante.
    // minute = Identificador da Variavel. Rotulo usado para acessar o resultado depois.
    // = = Operador de Atribuicao. Coloca o valor calculado dentro da variavel.
...
class _PrivateChatMessage {
  ...
  // text = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String text;
  // Analise da Linha: final String time;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // String = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // time = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final String time;
  // Analise da Linha: final bool isMine;
  // final = Modificador de Imutabilidade. Permite atribuir o valor uma unica vez.
  // bool = Tipo Declarado. Define a categoria de dado que esta propriedade aceita.
  // isMine = Identificador da Variavel. Nome usado para acessar o valor dentro da classe ou funcao.
  // ; = Finalizador de Instrucao. Encerra a declaracao do campo.
  final bool isMine;
